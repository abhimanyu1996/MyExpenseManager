...
public class Add_Fragment_Income extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        desc = (EditText) view.findViewById(R.id.incdesc);
        ...
        datebtn.setText(sdformat.format(date));

        //date button listener
        datebtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new SelectDateFragment(c,datebtn);
